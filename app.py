...
@app.route('/')
def index():
    return render_template('./templates/index.html')  # Agora Flask vai procurar em templates/index.html
...
def listar_veiculos():
    try:
        ...
        return render_template('./templates/listar.html',regs=veiculos)
    except Error as e:
...
def cadastrar_veiculo():
    ...
    try:
        ...
        return render_template('./templates/cadastrar.html', mensagem=mensagem)
    except Error as e:
        return jsonify({'erro': str(e)}), 500
    finally:
        conn.close()
...
def atualizar_veiculo(id):
    ...
    if request.method == 'GET':
        ...
        return render_template('./templates/editar.html', veiculo=veiculo)
...
def excluir_veiculo(id):
    ...
    if request.method == 'GET':
        ...
        return render_template('./templates/excluir.html', veiculo=veiculo)
